...
import { ArrowLeft, Volume2, BookOpen, Save } from 'lucide-react'
  ...
  useEffect(() => {
    const loadHexagram = async () => {
      try {
        ...
        const found = data.find((h: HexagramTranslation) => h.number.toString() === hexagramId)
        setHexagram(found || null)
      } catch (error) {
